...
if not df_estado.empty:
    ...
    plt.title(f'Promedio de Acres Quemados en Nueva York por Año')
...
if not df_estado.empty:
    ...
    plt.title(f'Promedio de Acres Quemados en Carolina Del Sur por Año')
